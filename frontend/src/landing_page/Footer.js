            ...
            <div className="container border-top mt-5">
                <div className="row mt-5">
                    ...
                    <div className="col">
                        ...
                        <a href="">Downloads & resorces</a> <br />
                    </div>
                    <div className="col">
                        <p>Account</p>
                ...
                <div className='mt-5 text-muted' style={{ fontSize: "16px" }}>
                    ...
                    <p>rocedure to file a complaint on SEBI SCORES: Register on SCORES portal. Mandatory details for filing complaints on SCORES: Name, PAN, Address, Mobile Number, E-mail ID. Benefits: Effective Communication, Speedy redressal of the grievances</p>
